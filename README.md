...
| `source/2026-05-21-imedtac-teams-api-followup/` | Microsoft Teams follow-up with Ben / Lauren / Johnny asking for the two-endpoint API document, preset questions/options, and not-sure answer-behavior guidance |
...
3. Respond to the Microsoft Teams follow-up:
   ...
   template by `2026-05-22` or `2026-05-25`; answer user-uncertainty behavior
   with explicit `not_sure` option IDs, with clinical review for required
   items.
4. Use `handoff/2026-05-21-imedtac-two-endpoint-api-reply.md` as the API response
   baseline and `handoff/2026-05-21-to-2026-05-25-imedtac-response-plan.md` as
   the internal Monday response plan.
